...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_queryinsurancedialog)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_queryinsurancedialog)()
{
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_queryinsurancedialog)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_queryinsurancedialog)()
{
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_queryinsurancedialog)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_queryinsurancedialog)(); }
   } dummy;
}
