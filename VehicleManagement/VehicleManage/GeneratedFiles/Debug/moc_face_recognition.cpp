...
QT_MOC_LITERAL(3, 42, 19) // "on_pBtnDone_clicked"
    ...
    "face_recognition\0on_pBtnHomepage_clicked\0"
...
const QMetaObject face_recognition::staticMetaObject = {
    { &BaseDialog::staticMetaObject, qt_meta_stringdata_face_recognition.data,
      qt_meta_data_face_recognition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *face_recognition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_face_recognition.stringdata0))
        return static_cast<void*>(const_cast< face_recognition*>(this));
