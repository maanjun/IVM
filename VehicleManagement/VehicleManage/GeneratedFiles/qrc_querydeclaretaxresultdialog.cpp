...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_querydeclaretaxresultdialog)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_querydeclaretaxresultdialog)()
{
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_querydeclaretaxresultdialog)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_querydeclaretaxresultdialog)()
{
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_querydeclaretaxresultdialog)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_querydeclaretaxresultdialog)(); }
   } dummy;
}
