...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_inputdonedialog)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_inputdonedialog)()
{
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_inputdonedialog)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_inputdonedialog)()
{
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_inputdonedialog)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_inputdonedialog)(); }
   } dummy;
}
