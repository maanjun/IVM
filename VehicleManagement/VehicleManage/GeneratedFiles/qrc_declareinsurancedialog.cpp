...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_declareinsurancedialog)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_declareinsurancedialog)()
{
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_declareinsurancedialog)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_declareinsurancedialog)()
{
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_declareinsurancedialog)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_declareinsurancedialog)(); }
   } dummy;
}
